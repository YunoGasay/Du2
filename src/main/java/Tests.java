...
public class Tests {
    ...
    public void GetHumanFormatSizeAllFlags() {
      ...
      test.add("[src\\main\\resources\\panda\\panda1.webp] 192.158 Kb");
      File tested = new File("src/main/resources/panda/panda1.webp");
    ...
    public void getHumanFormattedSize1CFlag() {
        ArrayList<String> test = new ArrayList<>();
        test.add("[src\\main\\resources\\panda\\panda1.webp] 192158 b");
        File tested = new File("src/main/resources/panda/panda1.webp");
    ...
    public void getHumanFormattedSize2CFlag() {
        ArrayList<String> test = new ArrayList<>();
        test.add("[src\\main\\resources\\panda\\panda2.jpg] 159.976 Kb");
        File tested = new File("src/main/resources/panda/panda2.jpg");
    ...
    public void getHumanFormattedSize2CFlagPanda() {
        ArrayList<String> test = new ArrayList<>();
        test.add("[src\\main\\resources\\panda] 352.134 Kb");
        File tested = new File("src/main/resources/panda");
